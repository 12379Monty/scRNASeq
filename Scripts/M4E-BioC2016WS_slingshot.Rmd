...
```{r Prelims, include=F, echo=F, results='hide', message=F,warning=F}
  ...
  cache_DIR <- file.path(WRKDIR, 'Scripts', 'cache/M4E/')
  suppressMessages(dir.create(cache_DIR, recursive=T))
  opts_chunk$set(cache.path=cache_DIR)

  figure_DIR <- file.path(WRKDIR, 'Scripts', 'figure/M4E/')
...
##TABLE_DIR <- file.path(WRKDIR, 'Scripts', 'tables', 'M4E')
...
```{r options, results="hide", include=F, cache=F, results='hide', message=F}
 SKIP.THIS <- function() {
 knitr::opts_chunk$set(fig.align="center", cache=F,
         error=F, #make it stop on error
         fig.width=7, fig.height=7, autodep=T, 
         out.width="600px", out.height="600px", results="markup", 
         echo=T, eval=T)
 }
##knitr::opts_knit$set(stop_on_error = 2L) #really make it stop
##knitr::dep_auto()
 options(getClass.msg=F) #get rid of messages about cache 
...
<!-- To run
 ...
 nohup sudo Rscript -e "knitr::knit2html('M4E-BioC2016WS_slingshot.Rmd')" > M4E-BioC2016WS_slingshot.log  &
