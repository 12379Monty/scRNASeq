...
### NOT RUN - Go through more recent clustering tutorial instead!
...
[clustering section](https://www.bioconductor.org/help/course-materials/2016/BioC2016/ConcurrentWorkshops1/Risso/clusterExperiment.html)


[See clustering tutorial](https://github.com/epurdom/clusterExperiment/blob/master/vignettes/clusterExperimentTutorial.Rmd)


```{r Prelims, include=F, echo=F, results='hide', message=F,warning=F}

  FN <- "M4C-BioC2016WS_clusterExp"
  ...
  cache_DIR <- file.path(WRKDIR, 'Scripts', 'cache/M4C/')
  suppressMessages(dir.create(cache_DIR, recursive=T))
  opts_chunk$set(cache.path=cache_DIR)

  figure_DIR <- file.path(WRKDIR, 'Scripts', 'figure/M4C/')
...
```{r setParam, echo=F}
 ...
 TABLE_DIR <- file.path(WRKDIR, 'Scripts', 'tables', 'M4C')
...
nohup sudo Rscript -e "knitr::knit2html('M4C-BioC2016WS_clusterExp.Rmd')" > M4C-BioC2016WS_clusterExp.log  &
